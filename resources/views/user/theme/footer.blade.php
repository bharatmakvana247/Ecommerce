                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="copyright-text">
                                <p class="copy-text"> © {{ date('Y') }} <strong>CDS</strong> Made With <i
                        ...
                        <div class="col-md-6">
                            <ul class="footer-payment text-right">
                                <li>
                                    <a href="#"><img src="{{ asset('user/img/payment/1.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('user/img/payment/2.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('user/img/payment/3.jpg') }}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{ asset('user/img/payment/4.jpg') }}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="modal-product clearfix">
                        <div class="product-info">
                            <form action="{{ route('user.customLogin') }}" method="post"
