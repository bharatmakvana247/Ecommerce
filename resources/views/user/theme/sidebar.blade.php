 ...
 <div class="style-customizer closed">
     <div class="buy-button">
         <a href="index.html" class="customizer-logo"><img src="{{ asset('user/images/logo/logo.png') }}"
                 alt="Theme Logo"></a>
