...
<script>
    ...
    $(document).on("click", "a.cart_remove", function(e) {
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ route('userside.cart.delete', ['']) }}" + "/" + id,
            type: 'post',
            data: {
                "_token": "{{ csrf_token() }}",
                id: id
    ...
    $(document).on("click", "a.wishlist_remove", function(e) {
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ route('userside.wishlist.delete', ['']) }}" + "/" + id,
            type: 'post',
            data: {
                "_token": "{{ csrf_token() }}",
                id: id
    ...
    $(document).on("click", "a.add_to_cart", function(e) {
        ...
        alert("CArt")
        $.ajax({
            url: "{{ route('userside.wishlist.addtocart', ['']) }}" + "/" + id,
            type: 'post',
            data: {
                "_token": "{{ csrf_token() }}",
                id: id
    ...
    $(document).on("click", "a.wishlist_add", function(e) {
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ route('userside.wishlist.store', ['']) }}" + "/" + id,
            type: 'post',
            data: {
                "_token": "{{ csrf_token() }}",
                id: id
    ...
    $(document).on("click", "a.ShowProduct", function(e) {
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{ route('userside.product.show') }}",
            type: 'get',
            data: {
                id: id
            },
