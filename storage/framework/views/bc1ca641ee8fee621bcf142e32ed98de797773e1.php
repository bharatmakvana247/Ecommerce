 ...
 <div class="style-customizer closed">
     <div class="buy-button">
         <a href="index.html" class="customizer-logo"><img src="<?php echo e(asset('user/images/logo/logo.png')); ?>"
                 alt="Theme Logo"></a>
     ...
     <div class="clearfix content-chooser">
         ...
         <ul class="patternChange main-bg-change clearfix">
             <li class="main-bg-1" data-style="main-bg-1" title="Background 1"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/01.jpg')); ?>" alt=""></li>
             <li class="main-bg-2" data-style="main-bg-2" title="Background 2"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/02.jpg')); ?>" alt=""></li>
             <li class="main-bg-3" data-style="main-bg-3" title="Background 3"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/03.jpg')); ?>" alt=""></li>
             <li class="main-bg-4" data-style="main-bg-4" title="Background 4"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/04.jpg')); ?>" alt=""></li>
             <li class="main-bg-5" data-style="main-bg-5" title="Background 5"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/05.jpg')); ?>" alt=""></li>
             <li class="main-bg-6" data-style="main-bg-6" title="Background 6"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/06.jpg')); ?>" alt=""></li>
             <li class="main-bg-7" data-style="main-bg-7" title="Background 7"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/07.jpg')); ?>" alt=""></li>
             <li class="main-bg-8" data-style="main-bg-8" title="Background 8"> <img
                     src="<?php echo e(asset('user/images/customizer/bodybg/08.jpg')); ?>" alt=""></li>
         </ul>
         <ul class="resetAll">
...
<?php /**PATH /var/www/html/BHARAT/CDS-2021/CDS/laravel/resources/views/user/theme/sidebar.blade.php ENDPATH**/ ?>