                                    ...
                                    <div class="card-body contacts_body">
                                        <ul class="contacts" id="user_serach">
                                            <?php $__currentLoopData = $user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li id="user_chat" data-id="<?php echo e($list->id); ?>" style="background:#FFF">
                                                    <div class="d-flex bd-highlight">
                                                        <div class="img_cont">
                                                            <img src="<?php echo e(url('uploads/' . $list->avatar)); ?>"
                                                                class="rounded-circle user_img">
                                                            <?php if($list->login_status == 'online'): ?>
                                                        ...
                                                        <div class="user_info">
                                                            ...
                                                            <p data-toggle="tooltip"
                                                                title="<?php echo e(\Illuminate\Support\Str::limit(@$messge_chat->message, 200, $end = '...')); ?>">
                                                                <?php echo e(\Illuminate\Support\Str::limit(@$messge_chat->message, 20, $end = '...')); ?>
                                                        ...
                                                        <?php if($count_chat != 0): ?>
                                                            <span
                                                                style="font-size: 14px;width: 30px;text-align: center;background: #4753c7;color: white;height: 20px;display: flex;justify-content: center;align-items: center;border-radius: 10px;float:right"><?php echo e($count_chat); ?></span>
                                                        <?php endif; ?>
                                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body msg_card_body">
                                        <p
                                            ...
                                            Wel Come <?php echo e(Auth::user()->name); ?>

                                        </p>
                                        <div style="text-align: center">
                                            <?php if(Auth::check() && Auth::user()->avatar): ?>
                                                <img src="<?php echo e(url('uploads/' . Auth::user()->avatar)); ?>"
                                                    class="rounded-circle user_img" style="height: 100px;width:100px">
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('user/img/logo/logo.png')); ?>"
                                                    class="rounded-circle user_img" style="height: 100px;width:100px">
                                            <?php endif; ?>
                                        </div>
                                        <center>
...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('user/chat/all.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('user/chat/chat.css')); ?>">
    <style>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $(document).on("click", "#user_chat", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('userside.chat.show')); ?>",
                type: 'get',
                data: {
                    id: id
                },
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BHARAT/Laravel/Ecommerce/resources/views/user/pages/chat/chat.blade.php ENDPATH**/ ?>